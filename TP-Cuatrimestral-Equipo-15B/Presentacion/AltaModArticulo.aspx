    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="m-3">
                ...
                <asp:RequiredFieldValidator ID="rfvCodigo" runat="server" CssClass="validator" ControlToValidate="txtCodigo" ErrorMessage="Este campo es requerido."></asp:RequiredFieldValidator>
            </div>
            <div class="m-3">
                <asp:Label ID="lblNombre" runat="server" CssClass="form-label" Text="Nombre de Artículo: "></asp:Label>
                <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvNombre" runat="server" CssClass="validator" ControlToValidate="txtNombre" ErrorMessage="Este campo es requerido."></asp:RequiredFieldValidator>
            </div>
            <div class="m-3">
            ...
            <div class="m-3">
                ...
                <asp:TextBox ID="txtDescripción" TextMode="MultiLine" CssClass="form-control" Height="400px" runat="server"></asp:TextBox>
            </div>
        </div>
        <div class="col-6">
            <div class="m-3">
            ...
            <div class="m-3">
                ...
                <asp:RangeValidator ID="RangeValidator1" runat="server" CssClass="validator" ErrorMessage="Ingrese sólo números." ControlToValidate="txtStock" Type="Integer" MinimumValue="1" MaximumValue="10000000"></asp:RangeValidator>
            </div>
